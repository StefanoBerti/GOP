...
ap.add_argument('-p', '--prototxt', help='path to Caffe deploy prototxt file', default="model_objects/MobileNetSSD_deploy.prototxt.txt")
ap.add_argument('-m', '--model', help='path to the Caffe pre-trained model', default="model_objects/MobileNetSSD_deploy.caffemodel")
