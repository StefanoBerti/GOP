...
class Rotation:
    def __init__(self, cam, gazebo=False, find_object=False, debug_show=False):
        self.cam = cam
        ...
        ##################################
        # Initialize tensor of ids and normalizer
        ...
        if find_object:
            ...
            self.object_net = cv2.dnn.readNetFromCaffe(params["OD_prototxt_path"],
        ...
        if self.find_object:
            ...
            for i in np.arange(0, detections.shape[2]):
                ...
                if confidence > params["object_min_conf"]:
                    ...
                    if self.CLASSES[idx] == "person":  # useless in our case
                        continue
                    ...
                    #             cv2.FONT_HERSHEY_COMPLEX, 0.5, self.COLORS[idx], 2)

                    objects[self.CLASSES[idx]] = (startX, startY, endX, endY)
        ...
        if boxes is not None:
            for i, elem in enumerate(boxes):
                ...
                if confidence > params["face_min_conf"]:  # threshold on face confidence
                    ...
                    # Print
                    # print("YAW: ", yaw_predicted.item(), ", PITCH: ", pitch_predicted.item(), ", ROLL: ",
                    #       roll_predicted.item())
                    # self.boss.send((yaw_predicted.item(), pitch_predicted.item(),
                    #                 roll_predicted.item()))
                    ...
                    if False:
                        ...
                        for o in objects.keys():  # translate box
                            ...
                            if l_seen or r_seen or u_seen or d_seen:
                                ...
                                cv2.putText(frame, 'FOCUS on ' + o, (20, 40 + n_focus * 30), cv2.FONT_HERSHEY_COMPLEX,
                                            1,
                                            color=(255, 255, 128))
